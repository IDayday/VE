...
def register_my_envs():
    ...
    register(
        id='AntULongTrainEnv-v1',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_u_long_fixed.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    # cross
    register(
        id='AntCrossTrainEnv-v0',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_cross.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    register(
        ...
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_pi.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    register(
        id='AntMazeMedTrainEnv-v100',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_maze_med_fixed.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    register(
        id='AntFgMedTrainEnv-v100',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_fg_med_fixed.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    register(
        id='AntFbMedTrainEnv-v100',
        entry_point='multiworld.envs.mujoco.classic_mujoco.ant_maze:AntMazeEnv',
        kwargs={
            'model_path': 'classic_mujoco/ant_gear10_dt3_fb_med_fixed.xml',
            'use_euler': True,
            'reward_type': 'vectorized_epos',
            'reset_and_goal_mode': 'uniform_pos_and_rot',
        }
    ...
    register(
        id="Reacher3D-v0",
        entry_point="multiworld.envs.mujoco.create_fetch_env:create_fetch_env",
