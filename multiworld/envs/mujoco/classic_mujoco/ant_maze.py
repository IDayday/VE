...
class AntMazeEnv(AntEnv):
    ...
    def __init__(
        ...
        if model_path in [
            ...
            'classic_mujoco/ant_gear10_dt3_u_long_fixed.xml',
            'classic_mujoco/ant_gear15_dt3_u_long_fixed.xml',
        ]:
            self.maze_type = 'u-long-fixed'
        elif model_path in [
            ...
            'classic_mujoco/ant_gear10_dt3_fb_med_fixed.xml',
        ]:
            self.maze_type = 'fb-med-fixed'
            ...
            'classic_mujoco/ant_gear10_dt3_maze_med_fixed.xml',
        ]:
            self.maze_type = 'maze-med-fixed'
        elif model_path in [
            'classic_mujoco/ant_gear10_dt3_fg_med.xml',
        ]:
            self.maze_type = 'fg-med'
        elif model_path in [
            'classic_mujoco/ant_gear10_dt3_fg_med_fixed.xml',
        ]:
            self.maze_type = 'fg-med-fixed'
        elif model_path in [
            'classic_mujoco/ant_gear10_dt3_cross.xml',
        ]:
            self.maze_type = 'cross'
        elif model_path in [
            'classic_mujoco/ant_gear10_dt3_pi.xml',
        ]:
            self.maze_type = 'large'
        elif model_path in [
            'classic_mujoco/ant_gear10_dt3_large.xml',
        ]:
            self.maze_type = 'large'
        else:
        ...
        if self.maze_type == 'u-small':
        ...
        elif self.maze_type == 'u-long-fixed':
            self.walls = [
                Wall(0, 1.5, 0.75, 7.5, self.wall_radius),
            ...
            if test_mode_case_num == 1:
                ...
                kwargs['goal_low'] = np.array([-0.25, -7.25])
                kwargs['goal_high'] = np.array([0.25, -7.75])
        ...
        elif self.maze_type == 'fb-med-fixed':
            self.walls = [
                Wall(-2.25, 1.5, 0.75, 4.5, self.wall_radius),
                Wall(2.25, -1.5, 0.75, 4.5, self.wall_radius),
        ...
        elif self.maze_type == 'maze-med-fixed':
            self.walls = [
                Wall(2.375, 3.25, 1.625, 0.75, self.wall_radius),
                Wall(-2.375, 3.25, 1.625, 0.75, self.wall_radius),
                Wall(0, 2, 0.75, 6, self.wall_radius),
        ...
        elif self.maze_type == 'fg-med-fixed':
            self.walls = [
                Wall(0, -3.25, 3, 0.75, self.wall_radius),
                Wall(-3.75, 0, 0.75, 4, self.wall_radius),
                Wall(3.75, 0, 0.75, 4, self.wall_radius),
        ...
        elif self.maze_type == 'cross':
            self.walls = [
                Wall(0, 0, 3.5, 0.5, self.wall_radius),
                Wall(0, 0, 0.5, 3.5, self.wall_radius),

                Wall(0, 8.0, 7.0, 1, self.wall_radius),
                Wall(0, -8.0, 7.0, 1, self.wall_radius),
                Wall(8.0, 0, 1, 9.0, self.wall_radius),
                Wall(-8.0, 0, 1, 9.0, self.wall_radius),
            ]

            if test_mode_case_num == 1:
                kwargs['reset_low'] = np.array([-5.75, 5.25])
                kwargs['reset_high'] = np.array([-5.25, 5.75])

                kwargs['goal_low'] = np.array([5.25, -5.75])
                kwargs['goal_high'] = np.array([5.75, -5.25])
            elif test_mode_case_num == 2:
                kwargs['reset_low'] = np.array([-5.75, -5.75])
                kwargs['reset_high'] = np.array([5.75, 5.75])

                kwargs['goal_low'] = np.array([-5.75, -5.75])
                kwargs['goal_high'] = np.array([5.75, 5.75])
        ...
        elif self.maze_type == 'pi':
            self.walls = [
                Wall(-6, 0, 1.5, 3.5, self.wall_radius),
                Wall(0, 0, 1.5, 3.5, self.wall_radius),
                Wall(6, 0, 1.5, 3.5, self.wall_radius),
            ...
            self.walls = [
                # inside walls
                Wall(0, 0, 9, 1., self.wall_radius),
                Wall(-2, 6, 3, 1., self.wall_radius),
                Wall(2, 6, 3, 1., self.wall_radius),
                Wall(0, -3, 9, 1., self.wall_radius),
                Wall(-5, -6, 3, 1., self.wall_radius),
                Wall(5, -6, 3, 1., self.wall_radius),
                ...
                # out walls
                Wall(0, 12.0, 11.0, 1, self.wall_radius),
                Wall(0, -12.0, 11.0, 1, self.wall_radius),
                Wall(12.0, 0, 1, 12.0, self.wall_radius),
                Wall(-12.0, 0, 1, 12.0, self.wall_radius),
            ]
